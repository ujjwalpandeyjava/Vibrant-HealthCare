...
export default function AboutUsPage() {
  return (
    <div className="flex-grow w-full max-w-5xl mx-auto px-4 md:px-8 py-16 animate-in fade-in duration-300">
      <div className="space-y-16">


        <div className="max-w-3xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold text-on-surface dark:text-white">About Vibrant Healthcare</h1>
